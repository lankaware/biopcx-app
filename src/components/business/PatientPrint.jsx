                        ...
                        <table >
                            <tbody >
                                <tr style={{ 'height': '3vh', 'fontSize': '18px', 'fontWeight': 'bold', 'verticalAlign': 'top', 'width': '500px' }}>
                                    <td style={{ 'fontFamily': 'times-new-roman', 'fontSize': '30px', 'width': '50vw' }}>{parse(props.recToPrint.name || '')} &nbsp; {parse(props.recToPrint.lastname || '')}</td>
                                    {/* <td style={{ 'fontSize': '22px', 'width': '20vw' }}>{parse(props.recToPrint.lastname || '')}</td> */}
                                ...
                                <tr style={{ 'height': '5vh', 'verticalAlign': 'top' }}>
                                    <td></td>
